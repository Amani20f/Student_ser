...
class StoreAbsenceExcuseRequest extends BaseServiceRequestRequest
{
    ...
    public function rules(): array
    {
        return array_merge(parent::rules(), [
            // Student Information
            'form_data.specialization' => ['required', 'string', 'max:255'],
            'form_data.level' => ['required', 'integer', 'between:1,8'],
            'form_data.college' => ['required', 'string', 'max:255'],
            'form_data.semester' => ['required', 'string', 'in:first,second'],
    ...
    public function messages(): array
    {
        return array_merge(parent::messages(), [
            'form_data.specialization.required' => 'Specialization is required.',
            ...
            'form_data.semester.in' => 'Semester must be first or second.',
