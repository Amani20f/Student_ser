        ...
        FilterBar(
          filters: [
            FilterDefinition(
              ...
              options: const [
                FilterValue(label: 'Admin', value: 'admin'),
                FilterValue(label: 'Staff Affairs', value: 'student_affairs'),
                FilterValue(label: 'Accountant', value: 'accountant'),
